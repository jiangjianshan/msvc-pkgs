...
PKG_NAME=x265
PKG_VER=3.6
PKG_URL=https://bitbucket.org/multicoreware/x265_git/downloads/${PKG_NAME}_$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
SRC_DIR=$PKGS_DIR/${PKG_NAME}_$PKG_VER
BUILD_DIR=$FWD/builds/${PKG_NAME}_$PKG_VER
...
configure_package()
{
  ...
  cmake -G "Ninja"                                                                                             \
    ...
    $SRC_DIR_M/source > >(build_log) 2>&1 || print_error
}
