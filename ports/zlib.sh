...
PKG_NAME=zlib
PKG_VER=1.3.1
PKG_URL=http://www.zlib.net/$PKG_NAME-$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
...
patch_package()
{
  ...
  sed                                                                \
    -e 's|-lz|-lzlib|g'                                              \
    zlib.pc.cmakein > zlib.pc.cmakein-t
  mv zlib.pc.cmakein-t zlib.pc.cmakein
  sed                                                                \
    -e 's|-lz|-lzlib|g'                                              \
    zlib.pc.in > zlib.pc.in-t
  mv zlib.pc.in-t zlib.pc.in
  popd
}
