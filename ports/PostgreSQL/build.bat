...
cd "%SRC_DIR%"
rem FIXME:
rem 1. Don't use -Dc_std=c17, it will cause 'error C2099: initializer is not a constant'
meson setup "%BUILD_DIR%"                                                      ^
  ...
  -Dc_winlibs="Advapi32.lib,Shell32.lib,User32.lib,pcrt.lib,ncurses.lib"       ^
  -Dcpp_winlibs="Advapi32.lib,Shell32.lib,User32.lib,pcrt.lib,ncurses.lib"     ^
