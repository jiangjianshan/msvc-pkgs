...
DEPENDS='googletest level-zero unified-memory-framework'
FWD=`dirname $(pwd)`
CWD=$(cd `dirname $0`; pwd)
PKG_NAME=unified-runtime
PKG_VER=0.8.14
PKG_URL=https://github.com/oneapi-src/unified-runtime/archive/refs/tags/v0.8.14.tar.gz
PKGS_DIR=$FWD/pkgs
