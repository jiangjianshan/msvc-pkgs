...
cd "%SRC_DIR%"
rem NOTE:
rem 1. The version 81.0.0 of setuptools has removed support for the –dry-run parameter to setup.py.
rem    see https://setuptools.pypa.io/en/stable/history.html
python -m pip install --upgrade pip setuptools==80.10.2 Mako Markdown
