...
set C_DEFS=-DWIN32 -D_WIN32_WINNT=_WIN32_WINNT_WIN10 -D_CRT_DECLARE_NONSTDC_NAMES -D_CRT_SECURE_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_NONSTDC_NO_WARNINGS -D_USE_MATH_DEFINES -DG_HAVE_ISO_VARARGS
...
set "GI_GIR_PATH=%GLIB_PREFIX:\=/%/share/gir-1.0;%GSTREAMER_PREFIX:\=/%/share/gir-1.0"
meson setup "%BUILD_DIR%"                                                                            ^
  ...
  -Dc_winlibs="Advapi32.lib,Gdi32.lib,OleAut32.lib,Ole32.lib,User32.lib,pthread.lib,iconv.lib"       ^
  -Dcpp_winlibs="Advapi32.lib,Gdi32.lib,OleAut32.lib,Ole32.lib,User32.lib,pthread.lib,iconv.lib"     ^
