...
cd "%BUILD_DIR%" && (
  ...
  xcopy /Y /F /I "%SRC_DIR%\libdcadec\dca_context.h" "%PREFIX%\include\libdcadec"
  xcopy /Y /F /I "%SRC_DIR%\libdcadec\dca_frame.h" "%PREFIX%\include\libdcadec"
  xcopy /Y /F /I "%SRC_DIR%\libdcadec\dca_stream.h" "%PREFIX%\include\libdcadec"
  xcopy /Y /F /I "%SRC_DIR%\libdcadec\dca_waveout.h" "%PREFIX%\include\libdcadec"
