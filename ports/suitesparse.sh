...
DEPENDS='gmp lapack llvm-project mpfr openblas'
FWD=`dirname $(pwd)`
CWD=$(cd `dirname $0`; pwd)
PKG_NAME=suitesparse
PKG_VER=7.7.0
PKG_URL=https://github.com/DrTimothyAldenDavis/SuiteSparse/archive/refs/tags/v$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
