...
PKG_VER=2024.05.08
PKG_URL=https://github.com/KhronosGroup/OpenCL-Headers/archive/refs/tags/v$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
...
patch_package()
{
  ...
  pushd $SRC_DIR
  patch -Np1 -i $PATCHES_DIR/001-OpenCL-Headers-2024.05.08-fix-install-configdir-on-cygwin.diff
  popd
}
