...
configure_package()
{
  ...
  check_triplet
  cd $BUILD_DIR
  # Fix issue of macro redefinition
  CPPFLAGS="${CPPFLAGS//-D_WIN32_WINNT=$WIN32_TARGET /}" 
  CPPFLAGS="${CPPFLAGS//_CRT_NONSTDC_NO_WARNINGS /}"
  CPPFLAGS="${CPPFLAGS//_CRT_SECURE_NO_WARNINGS /}"
  # NOTE: 
