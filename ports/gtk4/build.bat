...
set "GI_GIR_PATH=%GLIB_PREFIX:\=/%/share/gir-1.0;%GDK_PIXBUF_PREFIX:\=/%/share/gir-1.0;%PANGO_PREFIX:\=/%/share/gir-1.0;%HARFBUZZ_PREFIX:\=/%/share/gir-1.0;%GRAPHENE_PREFIX:\=/%/share/gir-1.0"
