...
DEPENDS='proj zlib libjpeg-turbo'
FWD=`dirname $(pwd)`
CWD=$(cd `dirname $0`; pwd)
PKG_NAME=libgeotiff
PKG_VER=1.7.1
PKG_URL=https://download.osgeo.org/geotiff/libgeotiff/$PKG_NAME-$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
...
patch_package()
{
  ...
  pushd $SRC_DIR
  patch -Np1 -i $PATCHES_DIR/001-libgeotiff-1.7.1-fix-cmake-doc-output-location.diff
  popd
}
