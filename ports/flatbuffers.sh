...
PKG_VER=24.3.25
PKG_URL=https://github.com/google/flatbuffers/archive/refs/tags/v$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
...
patch_package()
{
  ...
  pushd $SRC_DIR
  patch -Np1 -i $PATCHES_DIR/001-flatbuffers-24.3.25-fix-multiple-rules-generate-flatbuffers.diff
  popd
}
