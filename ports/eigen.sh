...
DEPENDS='llvm-project suitesparse'
FWD=`dirname $(pwd)`
...
configure_package()
{
  ...
  cmake -G "Ninja"                                                                                \
    ...
    -DCMAKE_C_FLAGS="-std:c17 -DEIGEN_STRONG_INLINE=inline $CFLAGS $CPPFLAGS_M"                   \
    -DCMAKE_CXX_COMPILER=clang-cl                                                                 \
    -DCMAKE_CXX_FLAGS="-std:c++20 -DEIGEN_STRONG_INLINE=inline $CXXFLAGS $CPPFLAGS_M"             \
