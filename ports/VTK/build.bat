...
cmake -G "Ninja"                                                                                                       ^
  ...
  -DCMAKE_C_STANDARD_LIBRARIES="Advapi32.lib Gdi32.lib Ole32.lib Shell32.lib User32.lib pcrt.lib pthread.lib"          ^
  -DCMAKE_CXX_COMPILER=cl                                                                                              ^
  -DCMAKE_CXX_COMPILER_LAUNCHER=sccache                                                                                ^
  -DCMAKE_CXX_FLAGS="-EHsc %C_OPTS% %C_DEFS%"                                                                          ^
  -DCMAKE_CXX_STANDARD_LIBRARIES="Advapi32.lib Gdi32.lib Ole32.lib Shell32.lib User32.lib pcrt.lib pthread.lib"        ^
