...
DEPENDS='bzip2 lz4 libxml2 pcre pcre2 xz zlib zstd'
FWD=`dirname $(pwd)`
CWD=$(cd `dirname $0`; pwd)
PKG_NAME=libarchive
PKG_VER=3.7.3
PKG_URL=https://www.libarchive.org/downloads/$PKG_NAME-$PKG_VER.tar.gz
PKGS_DIR=$FWD/pkgs
...
configure_package()
{
  ...
  #    command. To use windows's cmake, here have to use 'cygpath -w' to
