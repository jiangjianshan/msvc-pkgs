...
powershell Set-WinSystemLocale -SystemLocale en-US
...
echo [%~nx0] Checking CUDAN and CUDNN whether has been installed
...
if "%nv_gpu%" == "" (
  ...
  if "%CUDA_PATH%" == "" (
    ...
    set CUDA_VERSION=12.5.0_555.85
    ...
    if not exist "cuda_!CUDA_VERSION!_windows.exe" (
      ...
      curl -SL -o cuda_!CUDA_VERSION!_windows.exe https://developer.download.nvidia.com/compute/cuda/!cuda_major_minor!.0/local_installers/cuda_!CUDA_VERSION!_windows.exe
    )
    echo [%~nx0] Installing CUDA !CUDA_VERSION!, please wait ...
    cuda_!CUDA_VERSION!_windows.exe -s cuda_profiler_api_!cuda_major_minor! cudart_!cuda_major_minor! cuobjdump_!cuda_major_minor! demo_suite_!cuda_major_minor! nvcc_!cuda_major_minor! nvdisasm_!cuda_major_minor! nvfatbin_!cuda_major_minor! nvjitlink_!cuda_major_minor! nvml_dev_!cuda_major_minor! nvprof_!cuda_major_minor! nvprune_!cuda_major_minor! nvrtc_!cuda_major_minor! nvrtc_dev_!cuda_major_minor! opencl_!cuda_major_minor! sanitizer_!cuda_major_minor! cublas_!cuda_major_minor! cublas_dev_!cuda_major_minor! cufft_!cuda_major_minor! cufft_dev_!cuda_major_minor! curand_!cuda_major_minor! curand_dev_!cuda_major_minor! cusolver_!cuda_major_minor! cusolver_dev_!cuda_major_minor! cusparse_!cuda_major_minor! cusparse_dev_!cuda_major_minor! npp_!cuda_major_minor! npp_dev_!cuda_major_minor! nvjpeg_!cuda_major_minor! nvjpeg_dev_!cuda_major_minor!
    del /q cuda_!CUDA_VERSION!_windows.exe
    echo [%~nx0] Done.
    set CUDNN_VERSION=9.2.0.82
    ...
    if not exist "cudnn-windows-x86_64-!CUDNN_VERSION!_cuda!cuda_major!-archive.zip" wget https://developer.download.nvidia.com/compute/cudnn/redist/cudnn/windows-x86_64/cudnn-windows-x86_64-!CUDNN_VERSION!_cuda!cuda_major!-archive.zip
